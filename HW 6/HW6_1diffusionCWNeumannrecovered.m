...
L = 10;        % System extends from -L/2 to L/2
...
drawnow; 
saveas(gcf,'HW6_2Neumann_init','epsc');
pause(1);
...
for iter=1:max_iter
  ...
  if( rem(iter,plot_iter) < 1 )   
        ...
        drawnow;
        saveas(gcf,'HW6_2Neumann_plots','epsc');
...
saveas(gcf,'HW6_2Neumann_mesh','epsc');
...
saveas(gcf,'HW6_2Neumann_selplots','epsc');