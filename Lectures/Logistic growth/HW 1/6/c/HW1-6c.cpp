...
int main(){
	...
	std::ofstream bfile("HWbifurcations_c.txt");  //bfile is the file we will print bifurcation data
	std::ofstream pfile("HWperiods_c.txt");  //outfile is the file we will print period data
